...
<body class="bg-[#F1F5F9] h-screen flex flex-col font-sans">
        ...
        <main class="flex-1 overflow-y-auto p-6 md:p-8 custom-scroll">
            <div class="content-area">
                ...
                <div class="cert-grid">
                    ...
                    <div id="editModal-{{ $cert->id }}" style="display:none;position:fixed;top:0;left:0;right:0;bottom:0;z-index:9999;background:rgba(0,0,0,0.45);backdrop-filter:blur(4px);align-items:center;justify-content:center;padding:1rem;">
    ...
    <div id="modalHapusWrapper" style="display:none;position:fixed;inset:0;z-index:9999;min-height:240px;background:rgba(0,0,0,0.5);backdrop-filter:blur(4px);align-items:center;justify-content:center;">
