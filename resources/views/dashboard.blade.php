...
<body class="bg-slate-50 h-screen flex flex-col">
    ...
    <!-- Container Utama (Mengisi sisa layar) -->
    <div class="flex flex-1 overflow-hidden max-w-[1440px] mx-auto w-full">
        ...
        <!-- Main Content: No Scroll, Layout diperkecil -->
        <main class="flex-1 px-8 py-8 flex flex-col overflow-hidden">
            ...
            <!-- Statistik Cards (Diperkecil ukurannya) -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <!-- Card 1 -->
                <div class="bg-white p-6 rounded-[30px] shadow-sm flex flex-col items-start border border-slate-50 transition-all">
                    <div class="flex justify-between w-full items-start mb-4">
                        <div class="bg-blue-50 p-2 rounded-xl">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04kM12 21.75c-2.676 0-5.216-.584-7.499-1.632.43-4.14 3.65-7.368 7.499-7.368s7.069 3.228 7.499 7.368A11.954 11.954 0 0112 21.75z" />
                            </svg>
                        </div>
                ...
                <div class="bg-white p-6 rounded-[30px] shadow-sm flex flex-col items-start border border-slate-50 transition-all">
                    <div class="flex justify-between w-full items-start mb-4">
                        ...
                        <span class="bg-blue-50 text-blue-600 px-2 py-0.5 rounded-full text-[9px] font-black tracking-tight">88.4%</span>
                    </div>
                    ...
                    <div class="w-full bg-slate-100 h-1 rounded-full mt-3 overflow-hidden">
                        <div class="bg-indigo-500 h-full w-[88.4%] rounded-full shadow-lg"></div>
                    </div>
                </div>
            </div>

            <!-- Chart Section (Diperkecil ukurannya) -->
