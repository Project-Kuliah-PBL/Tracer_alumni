<nav class="sticky top-0 w-full shrink-0 bg-white shadow-sm border-b border-slate-100 z-50">
    <div class="w-full px-4 md:px-6 lg:px-8 py-2 md:py-3 flex items-center justify-between">
        ...
        <!-- ── TAMBAHAN SISI KANAN: Tombol Hamburger Mobile ── -->
        <div class="block lg:hidden">
            <button onclick="toggleSidebar()" class="p-2 rounded-xl bg-slate-50 border border-slate-200 text-slate-700 shadow-sm active:scale-95 transition-all">
