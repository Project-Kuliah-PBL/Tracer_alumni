    ...
    <div class="flex-1 flex items-center justify-center p-4 overflow-y-auto">
        ...
        <div class="w-full max-w-md bg-white p-6 md:p-8 rounded-2xl shadow-xl border border-slate-100">
            ...
            <form action="{{ route('password.reset') }}" method="POST">
                ...
                <button type="submit" class="w-full bg-[#004a80] hover:bg-blue-700 text-white font-bold py-3 rounded-xl shadow-lg transition-all transform hover:-translate-y-0.5">
                    Riset Password
                </button>
            </form>
