...
<div class="mb-4">
    ...
    <div class="relative flex items-center">
        <input type="password" id="passwordInput" name="password" placeholder="Kosongkan untuk pakai NIM sebagai password"
        ...
        <div class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer z-20" 
             onclick="
                ...
                if (input.type === 'password') {
                    input.type = 'text';
                    close.classList.add('hidden');    /* Sembunyikan mata dicoret */
                    open.classList.remove('hidden'); /* Tampilkan mata biasa */
                } else {
                    input.type = 'password';
                    close.classList.remove('hidden'); /* Tampilkan mata dicoret */
                    open.classList.add('hidden');    /* Sembunyikan mata biasa */
                }
             ">
